...
func InitModule(router fiber.Router, redisClient *redis.Client, authMiddleware fiber.Handler, broadcaster trackingport.BroadcasterPort) *usecase.LocationUseCase {
	...
	locationUC := usecase.NewLocationUseCase(locationRepo, broadcaster)
